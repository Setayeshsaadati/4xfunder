  ...
  <Box sx={{ display: "flex", justifyContent: "space-between", color: "#fff" }}>
    <Box mt={7} width={"65%"}>
      ...
      <Typography fontSize={17} mt={3}>
        ...
        معاملاتی متناسب با سطح مهارت خود را انتخاب میکند. در این مرحله، تیم
        پشتیبانی ۲۴ ساعته فورایکس فاندر همراه شماست تا با راهنمایی دقیق، بهترین
        گزینه را برای ورود به مسیر پراپ تریدینگ انتخاب کنید.
      </Typography>
    </Box>
    <Box width={"35%"} p={5}>
      photo
